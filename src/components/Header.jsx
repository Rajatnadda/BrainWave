...
const Header = () => {
  ...
  return (
    ...
    lg:bg-n-8/90 lg:background-blur-sm ${
    ...
    >
      ...
      >
       ...
       items-center justify-center m-auto lg:flex-row"
        ...
        <a className="button hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:black">
          New Account
        </a>
        <Link to="/login" className="hidden lg:flex m-4">
